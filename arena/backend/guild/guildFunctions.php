<?php
	...
	function loadGuilds(){
		...
		while($row = mysqli_fetch_assoc($result)){
			...
			echo "<div class='guildBox' id='" . $row['id'] . "'>";
				...
				echo "<img src='frontend/design/images/guilds/" . $row['image'] . "' style='width:40%;margin-left:30%;margin-right:30%;'></img>";
				echo "</div>";
				...
				function guildBoxes(){
					...
					if(id !== 'closeGuildCard'){
						...
						if (window.matchMedia('(max-width: 768px)').matches) {
							...
							var newWidth = $('#activeClone').parent().width()-20;
							var newLeft = 315;	
						}
	...
	function levelUpGui(){
		...
		echo "<div style='margin: auto;width:60%;text-align:center;border:1px solid orange;padding:10px;;margin-top:20px;'>";
